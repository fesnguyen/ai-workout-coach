...
class AnalysisCoverageJudge(BaseJudge):
    """
    Checks whether the generated response covers the expected findings.
    """
    ...
    async def evaluate(
        ...
        # Normalize expected finding groups (supports string or list of strings)
        expected_groups: list[list[str]] = []
        for item in case.expected.findings:
